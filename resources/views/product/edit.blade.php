                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        ...
                                        <!-- this is from -->
                                        <form class="form-valide" action="{{ route('product.update', $data->id) }}"
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label for=""
                                                                class="col-md-4 col-form-label">Product Number
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label for=""
                                                                class="col-md-4 col-form-label">Product Price
                                                                <span class="text-danger">*</span>
                                                            </label>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <label for="image" class="col-md-4 col-form-label">Image
